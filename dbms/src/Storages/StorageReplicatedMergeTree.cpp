...
#include <Storages/MergeTree/ReplicatedMergeTreeUpdateQuorum.h>
...
void StorageReplicatedMergeTree::updateQuorum(const String & part_name)
{
    ...
    while (zookeeper->tryGet(quorum_status_path, value, &stat))
    {
        ...
        if (quorum_entry.replicas.size() >= quorum_entry.required_number_of_replicas)
        {
            ...
            ReplicatedMergeTreeUpdateQuorum quorum_updater(data.format_version);
            String new_added_parts = quorum_updater.write(old_added_parts, part_name);
    ...
    const unsigned num_streams)
{
    ...
    */
    PartsIdToBlocks max_added_blocks_with_quorum;
    if (settings.select_sequential_consistency)
    {
        ...
        if (!added_parts_str.empty())
        {
            ...
            auto added_parts = quorum_updater.read(added_parts_str);
